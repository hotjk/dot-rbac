...
INSERT INTO `ace_demo_account` VALUES (1,6668.00),(2,99993332.00);
...
) ENGINE=InnoDB AUTO_INCREMENT=25958 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ace_demo_project` VALUES (1,'Test Project',99993332.00,1);
...
INSERT INTO `rbac_role_permission` VALUES (1,1),(1,2),(1,3),(1,4),(1,10),(1,20),(1,21),(1,22),(2,2),(3,1),(3,2),(3,3);
...
INSERT INTO `sequence` VALUES (1,4155,'Test'),(100,3,'CQRS_Account'),(101,2,'CQRS_Project'),(102,64525,'CQRS_Investment');
...
INSERT INTO `tree` VALUES (8,0,NULL,NULL),(8,1,0,2),(8,2,0,3),(8,3,0,10),(8,4,3,20),(8,5,4,21),(8,6,4,4),(8,7,6,22),(8,8,3,1);
...
-- Dump completed on 2014-10-20 17:41:21
