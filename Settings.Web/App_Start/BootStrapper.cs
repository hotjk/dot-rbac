...
namespace Settings.Web
{
    public class BootStrapper
    {
        ...
        {
            var settingsSqlOption = new Settings.Repository.MySql.SqlOption { ConnectionString = ConfigurationManager.ConnectionStrings["Settings.MySql"].ConnectionString };
            var treeSqlOption = new Grit.Tree.Repository.MySql.SqlOption { ConnectionString = ConfigurationManager.ConnectionStrings["Settings.MySql"].ConnectionString };
